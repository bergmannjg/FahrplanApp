...
function createIdxDs100WithCrossingsOfBetriebsstellenWithRailwayRoutePositions() {
    let obj = betriebsstellenWithRailwayRoutePositions.value
        .reduce((accu, bs) => {
...
function createIdxRailwayNrWithCrossingsOfBetriebsstellenWithRailwayRoutePositions() {
    let obj = {} as { [index: number]: Array<BetriebsstelleRailwayRoutePosition> };
...
function findStreckennutzungGeschwindigkeitForRailwayRouteNr(railwayRouteNr: number) {
    return streckeNrStreckennutzungGeschwindigkeit.value[railwayRouteNr] || 100
}

function findBetriebsstellenWithRailwayRoutePositionsForRailwayRouteNr(railwayRouteNr: number) {
    return railwayRouteNrOfBetriebsstellenWithRailwayRoutePositions.value[railwayRouteNr] || []
}

function findCrossingsOfBetriebsstellenWithRailwayRoutePositionsForRailwayRouteNr(railwayRouteNr: number) {
    return railwayNrWithCrossingsOfBetriebsstellenWithRailwayRoutePositions.value[railwayRouteNr] || []
}

function findCrossingsOfBetriebsstellenWithRailwayRoutePositionsForDS100(ds100: string) {
    return ds100WithCrossingsOfBetriebsstellenWithRailwayRoutePositions.value[ds100]
}

function getDs100ValuesForCrossingsOfBetriebsstellenWithRailwayRoutePositions() {
