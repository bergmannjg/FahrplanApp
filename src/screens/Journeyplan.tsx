...
import { View, Text, TouchableOpacity, Pressable, FlatList, ActivityIndicator, Linking } from 'react-native';
import { StackNavigationProp } from '@react-navigation/stack';
import { RouteProp } from '@react-navigation/native';
import { ListItem } from "react-native-elements";
import { useTranslation } from 'react-i18next';
import moment from 'moment';
import { Hafas, JourneyInfo, getLocation, isStopover4Routes } from '../lib/hafas';
...
export default function JourneyplanScreen({ route, navigation }: Props): JSX.Element {
	...
	const goToWagenreihung = (line?: Line, plannedDeparture?: string, origin?: Station | Stop | Location) => {
		...
		console.log('fahrtNr: ', line?.fahrtNr, ', plannedDeparture:', plannedDeparture, origin);

		const loc = getLocation(origin);
